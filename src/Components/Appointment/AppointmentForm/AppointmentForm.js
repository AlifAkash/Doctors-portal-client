    ...
    return (
        <div>
            ...
            >
                ...
                <h2 className="text-center primary">{appointmentOn}</h2>
                <p className="text-secondary text-center"><small>On {date.toDateString()}</small></p>
                <button className="btn btnPrimary" onClick={closeModal}>close</button>
                <form className="p-5" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="form-group text-right">
                        <button type="submit" className="btn btnPrimary">Send</button>
                    </div>
                </form>
            </Modal>
        </div>
